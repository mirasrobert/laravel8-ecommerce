                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card wish-list mb-4">
                            <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-3 text-muted text-uppercase small">Brand
                                                            - {{ $product->options->brand }}</p>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        ...
                                                        <a href="#!" type="button"
                                                           class="gray card-link-secondary small text-uppercase"><i
                                                                class="fa fa-heart gray mr-1"></i> Move to wish list
                                                        </a>
                                                    </div>
                                                    <p class="mb-0 text-black lead">
                                                        <span><strong>₱{{ $product->price }}</strong></span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <p class="text-primary mb-0"><i class="fa fa-info-circle mr-1"></i> For now we only
                                    accept Paypal and Credit or Debit Card. Thank you for patience.</p>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <dl class="dlist-align">
                                    <dt>Subtotal:</dt>
                                    <dd id="subtotal" class="text-right">{{ MyCart::subtotal()}}</dd>
                                </dl>
                                <dl class="dlist-align">
                                    <dt>VAT:</dt>
                                    <dd id="tax" class="text-right">{{ MyCart::tax()}}</dd>
                                </dl>
                                <dl class="dlist-align">
                                    <dt>Total:</dt>
                                    <dd id="total" class="text-right h5"><strong>₱{{ MyCart::total() }}</strong></dd>
                                </dl>
                                <hr/>
