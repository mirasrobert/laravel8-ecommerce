                        ...
                        <div id="rate-avg">
                            @if($rateAverage != 0)
                                ...
                                @for ($i = 0; $i < intval($rateAverage); $i++)
                                    <span><i class="fa fa-star checked pt-1"></i></span>
                                @endfor
                            @else
                                <span class="m-0 p-0">No ratings |</span>
                                @for ($i = 0; $i < 5; $i++)
                                    <span><i class="fa fa-star gray pt-1"></i></span>
                                @endfor
                            @endif
                        </div>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="card card-outline-secondary my-4">
                        ...
                        <x-product-review :product="$product" :reviews="$reviews" :hasReview="$hasReview"
                                          :canReview="$canReview"/>
